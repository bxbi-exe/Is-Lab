...
namespace web.Controllers
{
    public class TheatreShowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,ImageUrl,ShowDate,Place")] TheatreShow theatreShow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Title,Description,ImageUrl,ShowDate,Place")] TheatreShow theatreShow)
        {
